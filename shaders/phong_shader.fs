...
centroid in vec4 fragmentPosition;
centroid in vec4 fragmentNormal;
centroid in vec2 fragmentTextureCoords;
...
vec3 getPointColorOfLight(Light light)
{
	...
	float pointAttenuation = 1.0;//1.0 / (1.0 + 0.0014 * pointLightDistance +
